...
public class GeoAPIHelper {
    ...
    public void getLocationListAsync(GeoAPIPropertiesMap propertiesMap,
        ...
        int per_page = propertiesMap.getInteger(GeoAPIProperties.PER_PAGE, 500);
        int page = propertiesMap.getInteger(GeoAPIProperties.FIRST_PAGE, 1);
    ...
    public List<Geo> getLowerHouseLocationList(GeoAPIPropertiesMap propertiesMap) {
        ...
        optionParams.put(GeoService.PARAM_FIELD.page, String.valueOf(page));
        optionParams.put(GeoService.PARAM_FIELD.no_geo, String.valueOf(noGeo));
        GeoReturnObject returnObject = mGeoService.getLowerHouseLocation(optionParams);
        return returnObject.getData();
    }

    public void getLowerHouseLocationByRegion(String st_name, String dt_name, Callback<GeoReturnObject> returnObjectCallback) {
        getLowerHouseLocationByRegion(st_name, dt_name, new GeoAPIPropertiesMap(), returnObjectCallback);
    }

    public void getLowerHouseLocationByRegion(String st_name, String dt_name,GeoAPIPropertiesMap propertiesMap, Callback<GeoReturnObject> returnObjectCallback) {
        int per_page = propertiesMap.getInteger(GeoAPIProperties.PER_PAGE, 500);
        int page = propertiesMap.getInteger(GeoAPIProperties.FIRST_PAGE, 1);
        boolean noGeo = propertiesMap.getBoolean(GeoAPIProperties.NO_GEO, true);
        Map<GeoService.PARAM_FIELD, String> optionParams = new HashMap<>();
        ...
        optionParams.put(GeoService.PARAM_FIELD.page, String.valueOf(page));
        optionParams.put(GeoService.PARAM_FIELD.no_geo, String.valueOf(noGeo));
        optionParams.put(GeoService.PARAM_FIELD.st_name, String.valueOf(st_name));
        optionParams.put(GeoService.PARAM_FIELD.dt_name, String.valueOf(dt_name));
        mGeoService.getLowerHouseLocationAsync(optionParams, returnObjectCallback);
    }
